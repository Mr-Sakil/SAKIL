                ...
                button = [
                    [
                        InlineKeyboardButton(
                            "💥 Deploy Sakil Userbot ✨",
                            url=f"https://github.com/Mr-Sakil/SAKIL"
                        )
                    ]
                ]
                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://envs.sh/TLU.jpg",
                                title="🥀 Shukla Userbot ✨",
                                thumb_url=f"https://envs.sh/TLU.jpg",
                                description=f"🌷 Deploy Your Own USERBOT🌿...",
                                caption=f"<b>🥀 Welcome » To » Sakil 🌷\n✅ Userbot {__version__} ✨...</b>",
                        ...
                        (
                            InlineQueryResultArticle(
                                ...
                                input_message_content=InputTextMessageContent(
                                    f"||**🥀 Please, Deploy Your Own Userbot❗...\n\nRepo:** <i>https://github.com/Mr-Sakil/SAKIL/</i>||"
                                ),
                            )
                        )
                    ],
