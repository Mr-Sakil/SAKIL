...
async def run_async_clients():
    ...
    try:
        await app.send_message(LOG_GROUP_ID, "**sαкιℓ ιs αℓιvε.**")
    except:
        pass
    try:
        await app.join_chat("FellingThroughShayari")
        await app.join_chat("Vip_Sakil_Bio")
    except:
        pass
    if SESSION_STRING:
    ...
    try:
        await bot.send_message(LOG_GROUP_ID, "**sαкιℓ ιs αℓιvε.**")
    except:
        pass
