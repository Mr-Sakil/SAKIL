...
def generate_alive_image(
    ...
    background = Image.open("./SAKIL/resources/images/Sakilbot_alive.png").convert(
        "RGBA"
    )
...
async def draw_meme(
    ...
    font = ImageFont.truetype("./SAKIL/resource/fonts/Montserrat.ttf", font_size)
...
async def create_calendar(year: int, month: int) -> str:
    ...
    month_font = ImageFont.truetype("./SAKIL/resource/fonts/Montserrat.ttf", 40)
    month_x = (
    ...
    week_font = ImageFont.truetype("./SAKIL/resource/fonts/Montserrat.ttf", 1)
    ...
    font = ImageFont.truetype("./SAKIL/resource/fonts/Montserrat.ttf", 1)
